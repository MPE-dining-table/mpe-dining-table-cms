  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity
        style={[
          styles.menuItem,
          activeRoute === "Dashboard" && styles.menuItemActive,
        ]}
      ...
      {role === "super-admin" && (
        <>
          <TouchableOpacity
            style={[
              styles.menuItem,
              activeRoute === "Restaurants" && styles.menuItemActive,
            ]}
          ...
          <TouchableOpacity
            style={[
              styles.menuItem,
              activeRoute === "Admins" && styles.menuItemActive,
            ]}
          ...
          <TouchableOpacity
            style={[
              styles.menuItem,
              activeRoute === "UsersScreen" && styles.menuItemActive,
            ]}
      ...
      {role === "admin" && (
        <>
          <TouchableOpacity
            style={[
              styles.menuItem,
              activeRoute === "Bookings" && styles.menuItemActive,
            ]}
          ...
          <TouchableOpacity
            ...
            onPress={() => handleNavigation("AdminRestaurantsScreen")}
          >
            <Text style={styles.menuText}>🍴 My Restaurant</Text>
          </TouchableOpacity>
        </>
      )}
      ...
      <TouchableOpacity
        style={[
          styles.menuItem,
          activeRoute === "Reviews" && styles.menuItemActive,
        ]}
      ...
      <TouchableOpacity
        style={[
          styles.menuItem,
          activeRoute === "Settings" && styles.menuItemActive,
        ]}
